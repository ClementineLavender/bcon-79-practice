...
const inp31 = document.querySelector(".i-31");
const inp32 = document.querySelector(".i-32");
const out3 = document.querySelector(".out-3");

btn3.onclick = f3;
function f3() {
  const num1 = Number(inp31.value);
  const num2 = Number(inp32.value);
...
const inp71 = document.querySelector(".i-71");
const inp72 = document.querySelector(".i-72");
const out7 = document.querySelector(".out-7");

btn7.onclick = f7;

function f7() {
  const num1 = +inp71.value;
  const num2 = +inp72.value;
...
const inp120 = document.querySelector(".i-120");
const out12 = document.querySelector(".out-12");

btn12.onclick = f12;
function f12() {
  const a = inp120.value;
...
const inp130 = document.querySelector(".i-130");
const out13 = document.querySelector(".out-13");

btn13.onclick = f13;

function f13() {
  const b = inp130.value;
